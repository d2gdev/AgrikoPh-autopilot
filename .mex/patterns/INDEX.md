...
| [strategy-bound-seo-command-center.md](strategy-bound-seo-command-center.md) | Changing or verifying SEO analysis/UI that must remain bound to the exact active topical-map identity |
| [gsc-governed-remediation.md](gsc-governed-remediation.md) | Auditing or remediating Search Console data, sitemap, URL Inspection, theme, redirect, indexing, or ownership findings across Autopilot and Shopify |
